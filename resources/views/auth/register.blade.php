              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div data-mdb-input-init class="form-outline mb-4">
                    ...
                    <label class="form-label" for="form2Example22" name="password">mot de passe</label>
                  </div>

                  <div data-mdb-input-init class="form-outline mb-4">
                    <input type="password" name="password_confirmation" id="form2Example21" class="form-control" />
                    <label class="form-label" for="form2Example21" name="password_confirmation">mot de passe</label>
                  </div>
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger">Nouveau</button>
                  </div>
